...
namespace YusamHub\PdfExt\Fpdi;

use YusamHub\PdfExt\Fpdi\Filters\FilterASCII85;
use YusamHub\PdfExt\Fpdi\Filters\FilterASCIIHexDecode;
use YusamHub\PdfExt\Fpdi\Filters\FilterLZW;
    ...
    protected function _unFilterStream($obj)
    {
        ...
        if (isset($obj[1][1]['/Filter'])) {
            ...
            if ($filter[0] == PdfParser::TYPE_TOKEN) {
                $filters[] = $filter;
            } else if ($filter[0] == PdfParser::TYPE_ARRAY) {
                $filters = $filter[1];
            }
        }
